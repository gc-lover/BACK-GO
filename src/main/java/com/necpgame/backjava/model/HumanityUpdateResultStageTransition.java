...
@Schema(name = "HumanityUpdateResult_stage_transition", description = "Переход между стадиями (если произошел)")
@JsonTypeName("HumanityUpdateResult_stage_transition")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-11-06T19:56:57.236771400+03:00[Europe/Moscow]", comments = "Generator version: 7.17.0")
public class HumanityUpdateResultStageTransition {
  ...
  public HumanityUpdateResultStageTransition fromStage(@Nullable FromStageEnum fromStage) {
  ...
  public HumanityUpdateResultStageTransition toStage(@Nullable ToStageEnum toStage) {
  ...
  public HumanityUpdateResultStageTransition triggeredAt(@Nullable OffsetDateTime triggeredAt) {
  ...
  public boolean equals(Object o) {
    ...
    HumanityUpdateResultStageTransition humanityUpdateResultStageTransition = (HumanityUpdateResultStageTransition) o;
    return Objects.equals(this.fromStage, humanityUpdateResultStageTransition.fromStage) &&
        Objects.equals(this.toStage, humanityUpdateResultStageTransition.toStage) &&
        Objects.equals(this.triggeredAt, humanityUpdateResultStageTransition.triggeredAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromStage, toStage, triggeredAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HumanityUpdateResultStageTransition {\n");
