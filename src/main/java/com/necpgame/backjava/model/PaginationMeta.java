...
public class PaginationMeta {
   ...
   */
  public PaginationMeta(Integer page, Integer pageSize, Integer total, Integer totalPages) {
    this.page = page;
  ...
  public PaginationMeta hasNext(@Nullable Boolean hasNext) {
  ...
  public PaginationMeta hasPrev(@Nullable Boolean hasPrev) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.page, paginationMeta.page) &&
        ...
        Objects.equals(this.hasNext, paginationMeta.hasNext) &&
        Objects.equals(this.hasPrev, paginationMeta.hasPrev);
  }
