...
public interface InventoryInventoryApi {
    ...
    @RequestMapping(
        ...
        value = InventoryInventoryApi.PATH_DROP_ITEM,
    ...
    @RequestMapping(
        ...
        value = InventoryInventoryApi.PATH_EQUIP_ITEM,
        produces = { "application/json" },
    ...
    @RequestMapping(
        ...
        value = InventoryInventoryApi.PATH_GET_EQUIPMENT,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = InventoryInventoryApi.PATH_GET_INVENTORY,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = InventoryInventoryApi.PATH_UNEQUIP_ITEM,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = InventoryInventoryApi.PATH_USE_ITEM,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
