...
public interface NpcsNpcsApi {
    ...
    @RequestMapping(
        ...
        value = NpcsNpcsApi.PATH_GET_NPC_DETAILS,
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = NpcsNpcsApi.PATH_GET_NPC_DIALOGUE,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = NpcsNpcsApi.PATH_GET_NPCS,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = NpcsNpcsApi.PATH_GET_NPCS_BY_LOCATION,
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        ...
        value = NpcsNpcsApi.PATH_INTERACT_WITH_NPC,
        produces = { "application/json" },
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = NpcsNpcsApi.PATH_RESPOND_TO_DIALOGUE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
